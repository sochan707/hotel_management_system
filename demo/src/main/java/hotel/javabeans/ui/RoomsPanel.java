...
import hotel.javabeans.RoomType;
...
public class RoomsPanel extends JPanel {
    ...
    private void showAddDialog() {
        ...
        saveBtn.addActionListener(e -> {
            try {
                ...
                RoomType type = RoomType.valueOf((String) typeCb.getSelectedItem());
    ...
    private void showEditDialog() {
        ...
        saveBtn.addActionListener(e -> {
            try {
                room.setRoomType(RoomType.valueOf((String) typeCb.getSelectedItem()));
