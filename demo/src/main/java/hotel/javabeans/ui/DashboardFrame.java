...
public class DashboardFrame extends JFrame {
    ...
    private static final String NAV_INVOICES     = "Invoices";
    ...
    private JPanel buildSidebar() {
        ...
        if ("Manager".equalsIgnoreCase(role)) {
            ...
            addNavItem(sidebar, "🧾  " + NAV_INVOICES,    NAV_INVOICES);   // ← ADDED
        ...
        sh.setFont(new Font("SansSerif", Font.BOLD, 9));
        sh.setForeground(Theme.PINK_DIM);
        sh.setAlignmentX(LEFT_ALIGNMENT);
        sidebar.add(sh);
    ...
    private void addNavItem(JPanel sidebar, String label, String cardName) {
        ...
        btn.addActionListener(e -> {
            ...
            if (NAV_INVOICES.equals(cardName)     && invoicesPanel != null)     invoicesPanel.refreshTable();  // ← ADDED
            refreshStats();
    ...
    private JPanel statLine(String label, JLabel val) {
        ...
        val.setForeground(Theme.PINK_SOFT);
    ...
    private JPanel buildContent() {
        ...
        // Create panels in dependency order:
        // PaymentsPanel first (needed by InvoicesPanel)
        paymentsPanel = new PaymentsPanel(hotel);

        // InvoicesPanel needs PaymentsPanel
        invoicesPanel = new InvoicesPanel(hotel);
        invoicesPanel.setPaymentsPanel(paymentsPanel);

        // BookingsPanel needs InvoicesPanel
        bookingsPanel = new BookingsPanel(hotel);
        bookingsPanel.setInvoicesPanel(invoicesPanel);

        // ReservationsPanel needs BookingsPanel
        ...
        contentArea.add(invoicesPanel,     NAV_INVOICES);   // ← ADDED
